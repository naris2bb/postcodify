...
class Postcodify_Parser_Ranges_Jibeon extends Postcodify_ZipReader
{
    // 생성자에서 문자셋을 지정한다.
    ...
    public function read_line($delimiter = '|')
    {
        ...
        $dongri_ko = trim($line[7]); if (!$dongri_ko) $dongri_ko = null;
        $dongri_en = null;
        $admin_dongri = trim($line[8]); if (!$admin_dongri) $admin_dongri = null;
